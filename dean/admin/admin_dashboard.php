...
/* ================================================================
   STUDENT-PORTAL-INSPIRED ADMIN WORKSPACE
   Keeps the existing admin functionality/markup, but brings the
   visual language closer to the supplied Student Portal reference:
   dark navy sidebar + spacious light workspace + rounded cards.
   ================================================================ */
...
.page-content{
    ...
    margin-left:calc(var(--sidebar-w) * var(--sidebar-scale)) !important;
    width:calc(100% - (var(--sidebar-w) * var(--sidebar-scale))) !important;
...
.pbi-dashboard-container{
    ...
    background:linear-gradient(145deg,#FFFFFF 0%,#F8FBFF 55%,#F4F7FB 100%) !important;
    border:1px solid #DCE6F1 !important;
    border-radius:24px !important;
    box-shadow:0 10px 34px rgba(30,82,144,.07) !important;
}

/* --- sidebar stays dark and polished --- */
.pbi-sidebar{
    width:var(--sidebar-w) !important;
    background:#0B1C33 !important;
    border-right:1px solid rgba(255,255,255,.08) !important;
    box-shadow:3px 0 24px rgba(8,22,40,.18) !important;
}
.pbi-sidebar .nav-item{
...
.pbi-sidebar .nav-item.active .nav-icon-badge{
    background:rgba(37,99,235,.20) !important;
}
.pbi-sidebar .nav-item.active .icon{
...
.pbi-sidebar .nav-section-label{
    color:#8FC2F3 !important;
...
.sidebar-profile-logo{
    box-shadow:0 0 18px rgba(37,99,235,.17) !important;
}
...
.pbi-system-subtitle{
    ...
    color:#647A96 !important;
    margin:0 !important;
}
.pbi-dashboard-greeting{
    order:0;
    margin:0 0 7px !important;
    color:#0B1F3A !important;
    font-size:14px !important;
...
.pbi-dashboard-greeting .wave{font-size:15px;}
.pbi-dashboard-meta{
    display:flex !important;
    align-items:center !important;
    justify-content:flex-end !important;
...
.pbi-meta-updated{
    ...
    font-weight:600 !important;
    box-shadow:0 3px 10px rgba(30,82,144,.06) !important;
}
.pbi-meta-period i{color:#D97706 !important;}
.pbi-meta-updated i{color:#2563EB !important;}
.notif-btn{
...
.pbi-stat-card{
    ...
    background:#FFFFFF !important;
    box-shadow:0 5px 18px rgba(30,82,144,.07) !important;
    transform:none !important;
}
.pbi-stat-card:hover{
    transform:translateY(-2px) !important;
    box-shadow:0 10px 22px rgba(30,82,144,.10) !important;
}
.pbi-stat-card .pbi-stat-icon-circle{
    width:38px !important;
    height:38px !important;
    border-radius:10px !important;
...
.pbi-stat-card.stat-teal{border-top-color:#F59E0B !important;}
.pbi-stat-card.stat-teal .pbi-stat-icon-circle{background:#FFF1D6 !important;color:#C76A00 !important;}
.pbi-stat-card.stat-skyblue{border-top-color:#22C55E !important;}
.pbi-stat-card.stat-skyblue .pbi-stat-icon-circle{background:#DDF8E8 !important;color:#16813A !important;}
.pbi-stat-card.stat-violet{border-top-color:#EAB308 !important;}
.pbi-stat-card.stat-violet .pbi-stat-icon-circle{background:#FFF4C8 !important;color:#B7791F !important;}
.pbi-stat-card.stat-gold{border-top-color:#3B82F6 !important;}
.pbi-stat-card.stat-gold .pbi-stat-icon-circle{background:#E5EEFF !important;color:#2563EB !important;}
.pbi-stat-label{
...
.pbi-completion-ring{
    ...
    background:conic-gradient(#F59E0B calc(var(--pct)*1%), #E7EDF4 0) !important;
}
.pbi-completion-ring-inner{
...
.pbi-period-top{gap:18px 26px !important;margin-bottom:15px !important;}
.pbi-period-label{
    font-size:10.5px !important;
...
.pbi-period-tile.tile-progress{background:#FBFCFE !important;}
.pbi-period-tile-label{
    font-size:9.5px !important;
    letter-spacing:.08em !important;
    color:#6B809A !important;
}
.pbi-period-tile-value{
    font-size:22px !important;
    color:#0B1F3A !important;
}
.pbi-progress-track{height:9px !important;background:#E5EBF2 !important;}
.pbi-progress-fill{
    background:linear-gradient(90deg,#D97706,#F59E0B) !important;
}
.pbi-period-tile-value.green{color:#16A34A !important;}
.pbi-period-tile-value.gold{color:#C77A08 !important;}
...
.pbi-panel{
    ...
    box-shadow:0 5px 18px rgba(30,82,144,.06) !important;
}
.pbi-panel-title{
    font-size:11px !important;
